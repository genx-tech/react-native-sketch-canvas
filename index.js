...
import {Animated, TouchableOpacity, FlatList, ViewPropTypes} from 'react-native';
        ...
        <TouchableOpacity
            ...
            onPress={() => {
                if (this.state.color === item.color) {
                    const i = this.props.alphlaValues.indexOf(this.state.alpha);
                    if (this._alphaStep < 0) {
                        this._alphaStep = i === 0 ? 1 : -1;
                        this.setState({
                            alpha: this.props.alphlaValues[i + this._alphaStep],
                        });
                    } else {
                        this._alphaStep =
                            i === this.props.alphlaValues.length - 1 ? -1 : 1;
                        this.setState({
                            alpha: this.props.alphlaValues[i + this._alphaStep],
                        });
                    }
            ...
            <Animated.View style={this.props.containerStyle}>
                <Animated.View style={{flexDirection: 'row'}}>
                    ...
                    <Animated.View
                        ...
                        {this.props.redoComponent && (
                            <TouchableOpacity
                                onPress={() => {
                                    this.props.onRedoPressed(this.redo());
                                }}>
                                {this.props.redoComponent}
                            </TouchableOpacity>
                        )}
